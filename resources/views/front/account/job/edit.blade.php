                ...
                <form action="" method="post" id="editJobForm" name="editJobForm">
                    ...
                    <div class="card-body card-form p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" name="description" id="description" cols="5" rows="5" placeholder="Description">
                                {{ $job->description }}
                            </textarea>
                             <p></p>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" name="qualification" id="qualification" cols="5" rows="5" placeholder="Qualifications">
                                {{ $job->qualification }}
                            </textarea>
                        </div>
                        <div class="mb-4">
